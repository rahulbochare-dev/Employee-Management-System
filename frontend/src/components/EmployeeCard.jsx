...
const EmployeeCard = ({firstName, lastName, jobTitle, gender, empID, workMode, salary, email, func}) => {
    return (
        <div className='w-85 sm:w-85 w-full h-65 bg-white border border-[#b6b6b6] rounded-xl'>
    <div className="w-full h-17 flex justify-start gap-3 items-center pl-4 sm:pl-5">
        ...
        <div className="w-[78%] h-[75%] flex flex-col overflow-hidden">
            ...
            <h2 className="text-xs sm:text-sm text-[#929292] font-medium truncate">
                {email}
            </h2>
        </div>
    </div>
    ...
    <div className="w-full h-[45%] flex flex-col gap-2 pt-2">
        <div className='w-full h-[20%] flex pl-4 sm:pl-5 justify-between pr-6 sm:pr-10'>
            <h3 className="text-xs sm:text-sm text-[#929292] font-medium">
                Job Title:
            </h3>
