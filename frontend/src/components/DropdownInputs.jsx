...
const DropdownInputs = () => {
  return (
    <div className='w-50 h-60 border border-[#b6b6b6] rounded-xl flex flex-col items-center pt-2'>
        ...
        <button className='w-[85%] h-8 bg-[#CE78FF] rounded-xl mt-5 text-white font-medium hover:bg-[#C257FF] active:bg-[#B739FF]'>Done</button>
    </div>
  )
}
