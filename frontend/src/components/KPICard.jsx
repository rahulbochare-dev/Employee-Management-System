...
const KPICard = ({title, mainIcon, icon2, icon3, icon2Text, icon3Text, mainCount, icon2Count, icon3Count}) => {
  return (
    <>
    <div className='w-84 h-41.5 bg-white border border-[#b6b6b6] rounded-2xl overflow-clip'>
        <div className='w-full h-[6.688rem] rounded-t-2xl flex'>
          <div className='w-1/2 h-[6.688rem]'>
              ...
              <h1 className='text-5xl font-semibold pl-[1.313rem] pt-1'>{mainCount ?? "N/A"}</h1>
          </div>
        ...
        <div className='w-full h-[3.610rem] rounded-b-2xl overflow-clip flex'>
          <div className='w-4/8 h-full flex pl-4 justify-start items-center'>
            ...
            <h3 className='text-md font-semibold border-r border-[#b6b6b6] w-22 text-[#7D7D7D]'>{icon2Count ?? "N/A"} {icon2Text}</h3>
          </div>
          <div className='w-2/3 h-full flex pl-4 justify-start items-center'>
            <img className='w-7 mr-2' src={icon3} alt=""/>
            <h3 className='text-md font-semibold text-[#7D7D7D]'>{icon3Count ?? "N/A"} {icon3Text}</h3>
          </div>
        </div>
    </div>
    </>
