...
const getEmployees = function async(currentPage = 1, limit = 20) {
  const response = callApi(
    "GET",
    `/admin/employee/employees?page=${currentPage}&limit=${limit}`
  );
  return response;
};
...
const searchEmployee = function async(searchName) {
  const response = callApi(
    "GET",
    `/admin/employee/search-employee?searchName=${searchName}`
  );
  return response;
};
...
const getEmployeeBySalary = function async(minSalary, maxSalary) {
  const response = callApi(
    "GET",
    `/admin/employee/employee-by-salary?minSalary=${minSalary}&maxSalary=${maxSalary}`
  );
  return response;
};
...
const getEmployeeByFilter = function async(params) {
  const response = callApi(
    "GET",
    `/admin/employee/employee-by-filter/?${params}`
  );
  return response;
};
...
const terminateEmployee = function async(id) {
  const response = callApi(
    "POST",
    `/admin/employee/terminate-employee?id=${id}`
  );
  return response;
};
