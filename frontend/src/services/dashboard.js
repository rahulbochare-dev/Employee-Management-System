...
const getTotalEmployees = async function () {
  const response = await callApi(
    "GET",
    "/admin/dashboard/employee-gender-ratio"
  );
  return response;
};
...
const getPendingLeave = async function () {
  const response = await callApi(
    "GET",
    "/admin/dashboard/pending-leave-applications"
  );
  return response;
};
...
const getMostEmployeeCountry = async function () {
  const response = await callApi(
    "GET",
    "/admin/dashboard/most-employees-country"
  );
  return response;
};
...
const getEmployeeGenderRatioPercent = async function () {
  const response = await callApi(
    "GET",
    "/admin/dashboard/employee-gender-ratio-percent"
  );
  return response;
};
...
const getAverageEmployeeAge = async function () {
  const response = await callApi(
    "GET",
    "/admin/dashboard/average-employee-age"
  );
  return response;
};
