...
const registerUser = asyncHandler( async (req, res) => {
    const {firstName, lastName, userName, email, avatar, dateOfBirth, country, city, role, password, adminSecret} = req.body

    if(
        [firstName, lastName, userName, email, avatar, dateOfBirth, country, city, role, password, adminSecret].some((fields) => (fields?.trim() === ""))
    ){
